...
const toogleModalSingin = () => modalLogin.classList.toggle("show-modal2");

triggerLogin.addEventListener("click", toogleModalSingin);
closeButton2.addEventListener("click", toogleModalSingin);
...
formLogin.addEventListener("submit", () => {
  ...
  .then(
    () => {
        console.log("BIENVENIDO A TU SESIÓN");
        toogleModalSingin();
        alert("Bienvenido, ya estás en tu sesión");
    }
)
.catch(
    error => {
